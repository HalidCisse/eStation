...
namespace EStationCore.Managers {
    ...
    public sealed class CommManager {
        ...
        ///// <param name="maxResult"></param>
        ///// <returns></returns>
        //public List<ViewCard> GetPersonMessages(Guid personGuid, DateTime? fromDate = null, DateTime? toDate = null, int maxResult = 20){          
        //    using (var db = new StationContext())
        //    {
        //        if (fromDate == null || toDate == null)
        //        {
        ...
        //            var student = db.Customers.FirstOrDefault(s => s.Person.PersonGuid == personGuid);
        //            if (student == null)
        //                return mesMessages.Distinct()
        //                                  .OrderByDescending(m => m.DateAdded)
        //                                  .Take(maxResult)
        //                                  .ToList()
        //                                  .Select(m => new ViewCard(m, personGuid))
        //                                  .ToList();
        //            //var mesClasses =
